...
export class FGA implements GeneticAlgorithm {
  execute(params: GeneticAlgorithmExecutionParams) {
    ...
    let initial_population: Individual<any>[] = service.getIndividuals(
  ...
  generateMutated(initial_population: Individual<any>[]): Individual<any>[] {
    return initial_population.map((individual) => individual.mutate());
  }
  ...
  generateNextGeneration(
    params: GeneticAlgorithmExecutionParams,
    candidates: Individual<any>[]
  ): Individual<any>[] {
